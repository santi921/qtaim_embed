...
class TestLinkPredMetrics:
    ...
    def test_accuracy(self):
        ...
        concat_preds = torch.concat([self.preds, self.preds2, self.preds2])
        concat_labels = torch.concat([self.labels, self.labels2, self.labels2])
    ...
    def test_cross_entropy(self):
        ...
        assert (
            ...
            == compute_loss_cross_entropy(self.preds, self.labels).mean()
        )
