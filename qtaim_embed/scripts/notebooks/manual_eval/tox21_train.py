...
def main():
    ...
    print("-"*50)
    print("qtaim model:auroc: {:.4f} cross_entropy {:.4f}".format(float(np.array(stats_dict["auroc"]).mean()), float(np.array(stats_dict["cross_entropy"]).mean())))
    ...
    print("no qtaim model:  auroc: {:.4f} cross_entropy {:.4f}".format(float(np.array(stats_dict_no_qtaim["auroc"]).mean()), float(np.array(stats_dict_no_qtaim["cross_entropy"]).mean())))
