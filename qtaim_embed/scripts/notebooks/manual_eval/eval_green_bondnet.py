...
def main():
    ...
    config_qtaim = {
        "model": {
            ...
            "atom": ["grad_norm", "esp_total", "Hamiltonian_K", "eta", "eig_hess", "lap_norm", "esp_e", 
                "esp_nuc", "delta_g_hirsh", "delta_g_promolecular", "ave_loc_ion_E", "lap_e_density",
                "energy_density", "Lagrangian_K"],
            "bond": ["grad_norm", "ellip_e_dens", "ave_loc_ion_E", "esp_nuc", "energy_density",
                "esp_total", "Hamiltonian_K", "lap_norm", "esp_e",
    ...
    model_100= {
        "model": {"restore": True, "restore_path": "/home/santiagovargas/dev/qtaim_embed/data/saved_models/final_set/bondnet/0126/non/model_lightning_epoch=26-val_l1=14.55.ckpt"}
    }

    model_1000= {
        "model": {"restore": True, "restore_path": "/home/santiagovargas/dev/qtaim_embed/data/saved_models/final_set/bondnet/0126/non/model_lightning_epoch=38-val_l1=11.38.ckpt"}
    }
